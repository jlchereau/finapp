...
class TestPydanticJSONParser:
    ...
    async def test_strict_mode_no_data(self):
        ...
        assert "No data provided and strict mode is enabled" in str(
            exc_info.value
        )
    ...
    async def test_parse_invalid_jmespath(self):
        ...
        invalid_config = ParserConfig(
            ...
            fields={
                "price": {"expr": "invalid[[[expression", "default": 0.0}
            }
        )
...
class TestPydanticMultiSourceParser:
    ...
    def setup_method(self):
        ...
        self.parser1 = PydanticJSONParser(ParserConfig(
            name="Source1Model",
            fields={"price": {"expr": "price", "default": 0.0}}
        ))
        
        self.parser2 = PydanticJSONParser(ParserConfig(
            name="Source2Model",
            fields={"volume": {"expr": "volume", "default": 0}}
        ))
    ...
    async def test_parse_with_parser_exception_strict(self):
        ...
        strict_parser = PydanticJSONParser(ParserConfig(
            name="FailingModel",
        ...
        data_sources = [
            {"price": 150.50},
            {}  # This will fail the strict parser
        ]
